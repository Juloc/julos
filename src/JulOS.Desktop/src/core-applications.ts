...
const messages = {
  en: {
    settings: 'Settings', packages: 'Package Manager', packageStore: 'JulOS Store', agents: 'Agents', notifications: 'Notifications', problems: 'Problems', webappBrowser: 'Local Web',
  ...
  de: {
    settings: 'Einstellungen', packages: 'Paketverwaltung', packageStore: 'JulOS Store', agents: 'Agents', notifications: 'Benachrichtigungen', problems: 'Probleme', webappBrowser: 'Lokales Web',
