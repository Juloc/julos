...
export const shellMessageKeys = [
  ...
  'splitDivider',
  'updateAvailableBody',
  'updateAvailableConflict',
  'updateAvailableDiscard',
  'updateAvailableReload',
...
export const shellMessages: Readonly<Record<SupportedLanguage, ShellMessages>> = {
  en: {
    ...
    password: 'Password',
    splitDivider: 'Resize split view',
    updateAvailableBody: 'A new JulOS version is ready. Your open windows are saved before the page reloads.',
    updateAvailableConflict: 'Your desktop layout changed on another device. Resolve it or reload without saving this page.',
    updateAvailableDiscard: 'Reload without saving',
    updateAvailableReload: 'Reload now',
  ...
  de: {
    ...
    endSplit: 'Geteilte Ansicht beenden',
    displayNameRequired: 'Gib einen Anzeigenamen ohne Leerzeichen am Anfang oder Ende ein.',
    keepActiveInBackground: 'Im Hintergrund aktiv lassen',
    ...
    password: 'Passwort',
    splitDivider: 'Geteilte Ansicht anpassen',
    updateAvailableBody: 'Eine neue JulOS-Version ist bereit. Deine offenen Fenster werden vor dem Neuladen gespeichert.',
    updateAvailableConflict: 'Dein Desktop-Layout wurde auf einem anderen Gerät geändert. Löse den Konflikt oder lade diese Seite ohne Speichern neu.',
    updateAvailableDiscard: 'Ohne Speichern neu laden',
    updateAvailableReload: 'Jetzt neu laden',
