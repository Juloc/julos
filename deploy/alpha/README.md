...
- access to `ghcr.io/juloc/julos-server:0.4.0-beta.27`
...
mkdir -p julos-beta
cd julos-beta
curl -O https://raw.githubusercontent.com/Juloc/julos/v0.4.0-beta.27/deploy/alpha/compose.sqlite.yaml
curl -o .env.example https://raw.githubusercontent.com/Juloc/julos/v0.4.0-beta.27/deploy/alpha/.env.sqlite.example
cp .env.example .env
