...
- access to `ghcr.io/juloc/julos-server:0.3.0-alpha.9`
...
mkdir -p julos-alpha
cd julos-alpha
curl -O https://raw.githubusercontent.com/Juloc/julos/v0.3.0-alpha.9/deploy/alpha/compose.sqlite.yaml
curl -o .env.example https://raw.githubusercontent.com/Juloc/julos/v0.3.0-alpha.9/deploy/alpha/.env.sqlite.example
cp .env.example .env
...
```bash
curl -O https://raw.githubusercontent.com/Juloc/julos/v0.3.0-alpha.9/deploy/alpha/compose.yaml
curl -o .env.example https://raw.githubusercontent.com/Juloc/julos/v0.3.0-alpha.9/deploy/alpha/.env.example
cp .env.example .env
```
...
No Core schema change exists between alpha.8 and alpha.9. Existing alpha.8 SQLite volumes upgrade in place; no volume recreation or database edit is required.
